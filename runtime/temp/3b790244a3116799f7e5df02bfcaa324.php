<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:85:"/home/wwwroot/www.iseeyou.ac.cn/public/../application/admin/view/manage/blogroll.html";i:1481544341;}*/ ?>
<!DOCTYPE html>
<html lang="en">
	<head>
		<meta charset="utf-8" />
						...
						<div class="row">
							<div class="col-xs-12">
								...
								<h4 class="pink">
									...
									<a href="#modal-table" role="button" class="green" data-toggle="modal"> 友情链接 </a>

								</h4>
								<form action="__SITE__/admin/Manage/site_insert" method="post">
								<div class="row">
								  <div class="col-xs-2" >
								    <input type="text" class="form-control" placeholder="新增友链url" name="url"><br/>
								    <input type="text" class="form-control" placeholder="新增友链名称" name="name">
								  </div>
								  <div class="col-xs-1">
									...
									<div class="col-xs-12">
										...
										<div class="table-responsive">
											<table class="table table-hover">
												...
												<form action="__SITE__/admin/Manage/modify" method="post">
												<?php foreach($data as $d): ?>
												<tr>
													<td>
													<input type="text" name="modify[name][]" value="<?php echo $d['site_name']; ?>">
													</td>
													<td>
													<input type="hidden" name="modify[id][]" value="<?php echo $d['id']; ?>">
													</td>
													<td>
													<input type="text" name="modify[blogroll][]" value="<?php echo $d['blogroll']; ?>">
													</td>
													<?php if($d['switch'] == 0): ?>
													<td><b><a href="__SITE__/admin/Manage/close?id=<?php echo $d['id']; ?>"><font color="green">关闭链接</font></a></b></td>
													<?php else: ?>
													<td><b><a href="__SITE__/admin/Manage/close?id=<?php echo $d['id']; ?>"><font color="red">开启链接</font></a></b></td>
													<?php endif; ?>
													<td>
													<a href="__SITE__/admin/Manage/blogroll_delete?id=<?php echo $d['id']; ?>"><font color="red">
													<b>删除</b>
													</a>
													</td>
												</tr>
