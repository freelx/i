<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:82:"/home/wwwroot/www.iseeyou.ac.cn/public/../application/cadmin/view/index/index.html";i:1481706908;}*/ ?>
<html>
	<head>
		<meta charset="utf-8">
		<title></title>
    ...
    background: none;
				...
				<div class="header-menu">
					...
					<nav class="ms-nav">
						...
						<div class="ms-search">
						<?php if($notice): ?>
						<font color="red"><marquee>系统私信:<?php echo $notice; ?></marquee></font>
						<?php else: ?>
						<font color="red"><marquee>系统私信:暂无私信</marquee></font>
							...
							<div class="server-tab" style="margin-top: 26px;">
								...
								<div style="float: left;width:200px ;height: 152px;border: 1px #ccc solid;box-shadow: 1px 1px 1px #F5F5F5;padding: 5px;">
									<div style="width: 100%;height: 100%;border: 1px #F2873B dashed;">
										<span style="font-size: 18px;color: #686868;font-weight: bold;display: block;    display: block; width: 130px; margin-left: 50px;    margin-top:20px;"><?php echo $s; ?></span>
										<span style="font-size: 36px;color: #F88600;display: block;    display: block; width: 100px; margin-left: 50px;margin-top: 28;"></span>
										
											<input type="hidden" value="10" name="sign" id="ccc" />
									
										     <a href="__SITE__/cadmin/recharge/recharge"><input  type="submit" value="我要充值" style="background-color: #f56a48;border-radius: 5px;color: #fff; font-size:14px;border: 0px;width: 107px;height: 26px;margin-top: 30px;" /></a>
								...
								<div style="float: left;width:200px ;height: 152px;;margin-left: 20px;border: 1px #ccc solid;box-shadow: 1px 1px 1px #F5F5F5;padding: 5px;">
									<div style="width: 100%;height: 100%;border: 1px #F2873B dashed;">
									    ...
									    <span style="width: 87px;height: 20px;background-color: #fee3dc;padding: 5px;border: 1px #C62B26 dashed;border-radius: 5px;">您目前没有收益</span>
								...
								<div style="float: left;width:200px ;height: 152px;margin-left: 20px;border: 1px #ccc solid;box-shadow: 1px 1px 1px #F5F5F5;padding: 5px;">
									<div style="width: 100%;height: 100%;border: 1px #F2873B dashed;">
										...
										<?php foreach($data as $val): ?>
										<span style="width: 87px;height: 20px;background-color: #fee3dc;padding: 5px;border: 1px #C62B26 dashed;border-radius: 5px;"><?php echo $val->balance; ?></span>
										<?php endforeach; ?>
								...
								<!-- <div style="background-color: #fff;margin-top: 10px;height: 300px;padding: 10px;">
								 	...
								 	<img src="__SITE__/static/supp/img/个人中心/屏幕快照-2016-04-08-15.50.46.png" style="margin-top: 10px;height: 100px;width: 100px;float: left;"/>	
								 	<br />
								 	...
								 	<p style="width: 100px;font-size: 12px;color: #686868">化妆水化妆水化妆水化妆水化妆水化妆水</p>
								 	 ...
								 	 <div style="float:left ;">
								 	 	 <img src="__SITE__/static/supp/img/个人中心/屏幕快照-2016-04-08-15.50.46.png" style="margin-top: 10px;height: 100px;width: 100px;float: left;margin-left: 20px;"/>
								 	 	<br />
								...
								<div style="width: 680px;padding:10px;display: inline-block; margin-top:0px;background-color: #fff;float: left;">
									<!-- <div style="padding:10px ;text-align: center;float: left;">
										<div style="float: left;margin-left: 30px">
											<img src="__SITE__/static/supp/img/wdxx_01.png" />
