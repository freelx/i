<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:88:"/home/wwwroot/www.iseeyou.ac.cn/public/../application/admin/view/manage/information.html";i:1481618042;}*/ ?>
<!DOCTYPE html>
<html lang="en">
	<head>
		<meta charset="utf-8" />
						...
						<div class="row">
							<div class="col-xs-12">
								...
								<h4 class="pink">
									...
									<a href="#modal-table" role="button" class="green" data-toggle="modal"> 站点基础信息 </a>
									...
									<div class="col-xs-12">
										...
										<div class="table-responsive">
											<table class="table table-hover">
												...
												<form action="__SITE__/admin/Manage/imodify" method="post">
												<?php foreach($data as $d): ?>
												<tr>
												<td>
													<input type="text" name="modify[]" value="<?php echo $d['site_name']; ?>">
												</td>
												<td>
													<input type="text" name="modify[]" value="<?php echo $d['blogroll']; ?>">
												</td>
												<td>
													<input type="text" name="modify[]" value="<?php echo $d['record']; ?>">
												</td>
												<td>
													<input type="hidden" name="modify[]" value="<?php echo $d['id']; ?>">
												</td>									
												</tr>
												<?php endforeach; ?>
												<tr>
...
<div class="hr hr-18 dotted hr-double"></div>
													<?php foreach($data as $d): if($d['close'] == 1): ?>
													<td><b><a href="__SITE__/admin/Manage/jMo?id=<?php echo $d['id']; ?>"><font color="green">关闭站点</font></a></b></td>
													<?php else: ?>
													<td><b><a href="__SITE__/admin/Manage/jMo?id=<?php echo $d['id']; ?>"><font color="red">开启站点</font></a></b></td>
...
<!-- 				<table class="tb">
					...
					<tr>
						<td colspan="4">
							<div class="fixsel">
								<input type="submit" class="btn btn-info" id="submit_ipbansubmit" name="ipbansubmit" title="按 Enter 键可随时提交你的修改" value="提交" />
							</div>
						</td>
					</tr>
				</table> -->
