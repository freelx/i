<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:86:"/home/wwwroot/www.iseeyou.ac.cn/public/../application/admin/view/subject/treeview.html";i:1481617278;}*/ ?>
<!DOCTYPE html>
<html lang="en">
	<head>
		<meta charset="utf-8" />
		<title>管理中心-删除主题站</title>
		...
		<link rel="stylesheet" href="__SITE__/assets/css/jquery-ui-1.10.3.custom.min.css" />
		<link rel="stylesheet" href="__SITE__/assets/css/jquery.gritter.css" />
		...
		<script type="text/javascript">
					...
					{
					var oBtn = document.getElementById('btnw');
					var oFather = document.getElementById('father');
					
					var aSon = oFather.getElementsByTagName('input');
					...
					for (var i=0;i<aSon.length;i++) {
						...
						aSon[i].onclick = function ()
						{
							var n = 0;
							for (var i=0;i<aSon.length;i++) {
								if (aSon[i].checked == true) {
									n++;
								}
							}
		...
		<script src="__SITE__/assets/js/ace-extra.min.js"></script>
			...
			<div class="main-container-inner">
				...
				<div class="sidebar" id="sidebar">
					...
					<ul class="nav nav-list">
						<li class="active">
							<a href="__SITE__admin/index/index">
				...
				<div class="main-content">
					<div class="breadcrumbs" id="breadcrumbs">
					  ...
					  <div class="form-group">
					    <label for="name"><b>话题版块</b></label>
					  </div>
					
    				</div>
    				<div class="col-sm-offset-1 col-sm-6">
    				<input type="checkbox" id="btnw"/>&nbsp;&nbsp;&nbsp;全选<br
    				</div>
    				<form action="<?php echo url('admin/Subject/delete'); ?>"  method="post">
    				...
    				<div class="col-sm-offset-1 col-sm-6">
     				<div class="checkbox">
        			<label>
          			<input type="checkbox" name="theme[id][]" value="<?php echo $d['id']; ?>"><?php echo $d['theme_name']; ?><br>
        			</label>
      				</div>
    				</div>
  					</div>
...
<![endif]-->
		...
		<script src="__SITE__/assets/js/bootbox.min.js"></script>
		<script src="__SITE__/assets/js/jquery.easy-pie-chart.min.js"></script>
		<script src="__SITE__/assets/js/jquery.gritter.min.js"></script>
		<script src="__SITE__/assets/js/spin.min.js"></script>
				...
				*/
				...
				$('#gritter-regular').on(ace.click_event, function(){
					$.gritter.add({
						...
						image: $path___SITE__/assets+'/avatars/avatar1.png',
						sticky: false,
						time: '',
				...
				$('#gritter-sticky').on(ace.click_event, function(){
					var unique_id = $.gritter.add({
						...
						image: $path___SITE__/assets+'/avatars/avatar.png',
						sticky: true,
						time: '',
				...
				$('#gritter-max3').on(ace.click_event, function(){
					$.gritter.add({
						...
						image: $path___SITE__/assets+'/avatars/avatar3.png',
						sticky: false,
