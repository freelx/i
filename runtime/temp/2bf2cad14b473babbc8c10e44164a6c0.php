<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:88:"/home/wwwroot/www.iseeyou.ac.cn/public/../application/sadmin/view/business/business.html";i:1481110584;}*/ ?>
<!DOCTYPE html>
<html lang="en">
	<head>
		<meta charset="utf-8" />
		<title>字体 - 素材火 Admin</title>
		...
		<link rel="stylesheet" href="__SITE__/static/zassets/css/prettify.css" />
											...
											<div class="widget-header">
												...
												<div class="widget-toolbar no-border">
													<ul class="nav nav-tabs" id="recent-tab">
														<li class="active">
															<a data-toggle="tab" href="#task-tab">商户信息</a>
														</li>

														<!-- <li>
															<a data-toggle="tab" href="#member-tab">总销售次数</a>
														</li> -->
														...
														<li>
															<a data-toggle="tab" href="#topic-tab">话题评论管理</a>
														</li> -->
													</ul>
												</div>
											</div>
											...
											<div class="widget-body">		
												<div class="widget-main padding-4">
													<div class="tab-content padding-8 overflow-visible">
														...
														<form action="<?php echo url('sadmin/business/soft'); ?>" method="post">
...
<!-- 
														...
														<!-- <div id="topic-tab" class="tab-pane">
															...
															<tr class="success">
																<td><input type="checkbox" name="tt" value=""></td>
																<td></td>
																<td></td>
																<td></td>
																<td></td>
...
<![endif]-->
		...
		<script src="__SITE__/static/zassets/js/prettify.js"></script>
