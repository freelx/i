<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:83:"/home/wwwroot/www.iseeyou.ac.cn/public/../application/badmin/view/means/change.html";i:1481878972;}*/ ?>
<!DOCTYPE html>
<html>
				...
				<div data-am-widget="tabs" class="am-tabs am-tabs-d2">
					...
					<form action="<?php echo url('badmin/Means/dochange'); ?>" method="post">
						<?php foreach($info as $val): ?>
							...
							您的当前店名是<input type="text" name="shop_name" value="<?php echo $val->shop_name; ?>" style="width: 285px;height: 45px;margin-left: 20px;"><br /><br />
							您的当前电话是<input type="text" name="tel" value="<?php echo $val->tel; ?>" style="width: 285px;height: 45px;margin-left: 20px;"><br /><br />
							您的店铺地址是<input type="text" name="ship_address" value="<?php echo $val->ship_address; ?>" style="width: 285px;height: 45px;margin-left: 20px;"><br /><br />
