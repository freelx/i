<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:86:"/home/wwwroot/www.iseeyou.ac.cn/public/../application/admin/view/subject/elements.html";i:1481616503;}*/ ?>
<!DOCTYPE html>
<html lang="en">
	<head>
		<meta charset="utf-8" />
		<title>管理中心-现有主题站</title>
...
<li>
				...
				<div class="main-content">
    				...
    				<form action="<?php echo url('admin/Subject/Modify'); ?>"  method="post">
    				<?php foreach($data as $d): ?>
					
					
					<div class="col-sm-offset-1 col-sm-6">
      					<input type="hidden" name="theme[id][]" value="<?php echo $d['id']; ?>" /><input type="text" name="theme[theme_name][]" class="form-control" value="<?php echo $d['theme_name']; ?>"><br>
