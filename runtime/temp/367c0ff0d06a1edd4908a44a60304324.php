<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:82:"/home/wwwroot/www.iseeyou.ac.cn/public/../application/badmin/view/means/means.html";i:1481617644;}*/ ?>
...
<body>
<form action="<?php echo url('badmin/Means/improve'); ?>" method="post"  enctype="multipart/form-data">
	<fieldset>
		<legend>店铺信息完善</legend>
		<label for="">
			店铺名: <input type="text" required autofocus placeholder="请输入店铺名称" name="shop_name">
		</label>
		<label for="">
			店铺地址: <input type="text" required autofocus placeholder="请输入店铺地址" name="shop_address">
		</label>
		<label for="">
		...
		<label for="">
			您的: <input type="text" list="course" placeholder="北京" name="address">
			<datalist id="course">
