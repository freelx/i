<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:88:"/home/wwwroot/www.iseeyou.ac.cn/public/../application/cadmin/view/recharge/recharge.html";i:1481695000;}*/ ?>
<!DOCTYPE html>
<html>
	...
	<body>
		...
		<div class="am-g" >
			<div class="logo"> <img src="__SITE__/static/supp/img/logo.png" style="    float: left" />
				<p style="font-size: 16px;color: #3d3d3d;margin-left: 16px;font-weight: bold;margin-top: 20px;    float: left">请您充值</p>
			</div>
			<div style="width: 1200px;margin: 0 auto;font-size: 12px;margin-top: -38px;"> <span style="float: right;color: #333333;">欢迎您，尊敬的会员<?php echo \think\Session::get('username'); ?><span style="margin-left: 20px;margin-right: 20px;">|</span><span style="margin-left: 20px;margin-right: 20px;">|</span></span>
			</div>
		</div>
		</div>
				...
				<div data-am-widget="tabs" class="am-tabs am-tabs-d2">
					<ul class="am-tabs-nav1" style="margin-top: 20px;display:flex;list-style: none;text-align: center;">
						...
						<li style="max-width: 80px;margin-left: 10px;"><span class="am-badge1  am-round am-badge-warning-active" style="background-color: #F89406;font-size: 18px">赞</span>
							<br />
							<p class="bottitle active">我要充值</p>
						</li>
						
					</ul>
					<form action="<?php echo url('cadmin/recharge/dochange'); ?>" method="post">
						
							<div class="new">
							您要充值的金额<input type="text" name="money" value="" style="width: 285px;height: 45px;margin-left: 20px;"><br /><br />
							<!-- 您的当前地址是<input type="text" name="address" value="" style="width: 285px;height: 45px;margin-left: 20px;"><br /><br />
							您的当前电话是<input type="text" name="tel" value="" style="width: 285px;height: 45px;margin-left: 20px;"><br /><br /> -->
