<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:82:"/home/wwwroot/www.iseeyou.ac.cn/public/../application/index/view/bauth/blogin.html";i:1481678338;}*/ ?>
...
<script type="text/javascript">
	$(function(){
		...
		$('#sub').click(function (){
					$.post('__SITE__/index/Bauth/loginCheck',{username:$('#username').val(),password:$('#password').val()},function(data){
						if (data.status) {
...
<div class="tyg-div-denglv">
	<div class="tyg-div-form">
			<h1 id="msg"></h1>
			<h2><a href="__SITE__index/auth/login">会员登录</a>/<font color="green">商户登录</font></h2><!-- <p class="tyg-p">欢迎访问  智慧能力</p> -->
