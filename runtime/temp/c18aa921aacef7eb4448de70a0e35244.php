<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:83:"/home/wwwroot/www.iseeyou.ac.cn/public/../application/index/view/auth/register.html";i:1481678054;}*/ ?>
<!doctype html>
<html lang="en">
<head>
	<meta charset="UTF-8">
        ...
        $(function(){
            ...
            function checkPassword() {
                    ...
                    if (reg.test($("#password").val())) {
                        ...
                        $("#password").next().html('<font color="red">密码需为6到32位</font>');
                        return false;
                    }
                }
            ...
            function checkVerify(){
                    ...
                    var i;
                    $.post('__SITE__/index/Auth/verify',{verify:$("#verify").val()},function(data){
                        if (data.status) {
                ...
                j = checkVerify();
                if (checkPassword() && j) {
                        $.post('__SITE__/index/Auth/registerVerify',{username:$("#username").val(),password:$("#password").val()},function(data){
                            if (data.status) {
                               /* $("#sub").val(data.msg);*/
                                setTimeout(function(){
                                    location.href='__SITE__/index/auth/login';
                                },1000);
                            } else {
                                alert(data.msg);
                            }
...
<div class="zhuce_body">
    ...
    <div class="zhuce_kong">
    	<div class="zc">
        	<div class="bj_bai">
            <h3><font color="green">会员注册 </font>/<a href="__SITE__index/bauth/bregister">商户注册</a></h3>
