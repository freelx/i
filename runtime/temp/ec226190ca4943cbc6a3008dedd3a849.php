<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:82:"/home/wwwroot/www.iseeyou.ac.cn/public/../application/badmin/view/order/order.html";i:1481629550;}*/ ?>
<html>
	...
	<head>
		...
		<link rel="stylesheet" href="__SITE__/static/buss/css/caiyun.css">
		<link rel="stylesheet" href="__SITE__/static/buss/css/bootstrap.css">
	...
	<body class="ms-body">
		...
		<div class="ng-toolbar">
			<div class="ng-toolbar-con wrapper">
				<div class="ng-toolbar-left">
					<a class="ng-bar-node ng-bar-node-backhome" id="ng-bar-node-backhome" style="display: block;" href="__SITE__index/index/index">
						<span><img src="__SITE__/static/supp/img/Home.png" style="margin-right: 10px;"/>返回首页</span><span style="margin-left: 20px;"><a href="__SITE__/cadmin/means/means">完善我的资料</a></span>&nbsp;&nbsp;&nbsp;<span><a class="bind-phone" href="__SITE__/cadmin/means/change"><i style="background-image: url(__SITE__/static/supp/img/修改手机.png);"></i>修改个人信息</a></span>
					</a>
				...
				<div class="ng-toolbar-right">
					...
					<div class="ng-bar-node-box mysuning-handle">
						<a href="" rel="nofollow" name="" class="ng-bar-node ng-bar-node-fix touch-href ng-bar-node-pr5"><span>欢迎<?php echo \think\Session::get('businessname'); ?></span><em class="ng-iconfont down"></em></a>
					...
					<a href="" class="ng-bar-node ng-bar-node-pr5" target="_blank"><span></span><em class="ng-iconfont down"></em></a>
					<div class="ng-bar-node-box service-handle">
						<a href="" class="ng-bar-node ng-bar-node-service ng-bar-node-fix touch-href ng-bar-node-pr5" rel="nofollow"><span></span><em class="ng-iconfont down"></em>
									    </a>
				...
				<div class="header-useinfo" id="">
					...
					<div class="ms-name-info">
						...
						<div class="info-member">
        				 ...
        				 <i></i><a target="_blank" ></a></span>
							<span style="margin-left: 20px;">
        				 <a href="__SITE__/cadmin/means/means"></a></span>
						</div>
						<div class="info-safety">
							<span class="safety-lv lv-3">
					
        				<a href="__SITE__/cadmin/means/load"></a>
        			</form>
							</span>
							<a class="bind-phone" href="__SITE__/cadmin/means/change">
								<i style="background-image: url(__SITE__/static/supp/img/);"></i></a>
						</div>
					</div>
				</div>
		...
		<div id="ms-center" class="personal-member">
			<div class="cont">
					...
					<div class="ms-side" style="margin-top: 20px;" >
						<article class="side-menu side-menu-off">
							<dl class="side-menu-tree" style="padding-left: 50px;" >
								...
								<dd>
									<a style="color:#f70" href="__SITE__/badmin/order/order"></span>我的订单</a>

								</dd>


								<!-- <dt><img src="__SITE__/static/supp/img/左侧/我的买啦.png"  style="margin-right: 10px;margin-left: -20px;"/>我的买啦</dt>
								<dd>
									<a>保留2</a>
								
								</dd>
								
								<dt><img src="__SITE__/static/supp/img/左侧/v-card-3.png"  style="margin-right: 10px;margin-left: -20px;"/>售后服务</dt>
								<dd>
									<a>保留3</a>
				...
				<div class="cont-main">
					<div class="main-wrap mt15" style="border: 0px;">
						      <ul class="sui-nav nav-tabs" style="margin-top:0px;width: 1000px;margin-left: 30px;">
								  <li   style="margin-left: -5px;"><a href="#profile" data-toggle="tab">订单<span style="margin-left: 20px;color: #ccc;">|</span></a></li>
							...
							<div class="tab-content" style="width: 1000px;margin-top: 10px;border:1px #fff solid; border-top:transparent;margin-left: 30px;">
								...
								<span style="line-height: 50px;"><?php echo $d['data']; ?></span>
								<span style="line-height: 50px;margin-left: 20px;">订单号：<?php echo $d['feature_code']; ?></span>
								<span style="line-height: 50px;margin-left: 100px;"><?php echo $d['shop_name']; ?></span>
								<img src="__SITE__/static/supp/img/speech-bubble-3-拷贝.png" style="margin-left: 100px;"/> <span>和我联系</span>
								 </div>	
								 <div style="float: left;width: 65%;height: 93px;">
								 	<div style="width: 100%;">
								 	<img src="<?php echo $d['pic']; ?>" style="height: 100px;float: left;" />
								 	<dl style="width: 220px;float: left;margin-left: 20px;margin-top: 20px;"><?php echo $d['goods_name']; ?></dl>

								    <dl style="float: left;margin-left: 50px;margin-top: 40px;"><?php echo $d['price']; ?></dl>
								    <span style="margin-left: 40px;">数量:<?php echo $d['num']; ?></span>
								    ...
								    <dl style="float: left;margin-left: 320px;margin-top: 30px;">￥:1</dl>
								     <span style="margin-left: 40px;">数量:<?php echo $d['num']; ?></span>
								    </div>
								 ...
								 <div style="float: left;border-left: 1px #addff8 solid;width: 11%;height:200px;text-align: center;">
								 	...
								 	<span style="font-weight: bold;margin-top: 30px;display: block;"><?php echo $d['price'] + 6; ?></span>
								 	<dl>(含运费:5)</dl>
								 	
								 </div>
								 <div style="float: left;border-left: 1px #addff8 solid;width: 11%;height:200px;text-align: center ;">
								 	<dl style="margin-top: 30px;">买家已付款</dl>
								 	<dl>订单详情</dl>
								 	<dl>查看物流</dl>
								 </div>
								 <div style="float: left;border-left: 1px #addff8 solid;width: 11%;height:200px;text-align: center ;">
								 	<dl style="margin-top: 30px;"></dl>
								 		<?php if($d['send'] == 1): ?>
                                        <a href="#"><button type="button" class="btn btn-success">已发货</button></a>
                                        <?php else: ?>   
                                        <a href="__SITE__/badmin/order/change?goods_id=<?php echo $d['goods_id']; ?>"><button type="button" class="btn btn-danger">发货</button></a>
                                       	<?php endif; ?>
								 </div>
								 </div>
				...
				<div style="text-align:left;margin-top: 20px;width: 1100px;border-top: 1px #ccc solid;padding-top: 10px;margin-left: -70px;">
                       ...
                       <hr style=" border-top:0.01rem #ccc solid;width:100%;margin-top: 10px;"> </hr>
