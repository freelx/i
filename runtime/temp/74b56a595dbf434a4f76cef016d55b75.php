<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:85:"/home/wwwroot/www.iseeyou.ac.cn/public/../application/admin/view/subject/buttons.html";i:1481616794;}*/ ?>
<!DOCTYPE html>
<html lang="en">
	<head>
		<meta charset="utf-8" />
		<title>管理中心-增加主题站</title>
				...
				<div class="main-content">
					<div class="breadcrumbs" id="breadcrumbs">
						...
						<ul class="breadcrumb">
							...
							<li class="active">增加主题站</li>
						</ul><!-- .breadcrumb -->

						
					</div>

				<form action="<?php echo url('admin/Subject/Added'); ?>"  method="post">

					
					<div class="col-sm-offset-1 col-sm-11">
 
					  <div class="form-group">
					    <label for="name"><b>新增话题版块</b></label>
					  </div>
					
    				</div>
					<div class="col-sm-offset-1 col-sm-6">
						<input type="text" name="theme_name" class="form-control" placeholder="新增版块名"><br/>
