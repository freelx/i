<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:82:"/home/wwwroot/www.iseeyou.ac.cn/public/../application/sadmin/view/index/index.html";i:1481786494;}*/ ?>
<!DOCTYPE html>
<html lang="en">
	<head>
		<meta charset="utf-8" />
			...
			<div class="main-container-inner">
				...
				<div class="sidebar" id="sidebar">
					...
					<ul class="nav nav-list">
						...
						<li>
							<a href="__SITE__/sadmin/business/business" class="dropdown-toggle">
											...
											<div class="widget-header">
												...
												<div class="widget-toolbar no-border">
													<ul class="nav nav-tabs" id="recent-tab">
														...
														<li>
															<a data-toggle="tab" href="#comment-tab">会员账号管理</a>
														</li>
														<li>
															<a data-toggle="tab" href="#topic-tab">评论管理</a>
														</li>
													</ul>
												</div>
											</div>
												...
												<div class="widget-main padding-4">
													<div class="tab-content padding-8 overflow-visible">
														...
														<div id="task-tab" class="tab-pane active">
															<form action="<?php echo url('sadmin/index/soft'); ?>" method="post">
																<table width="700" height="200" class="table table-condensed">
															    	...
															    	<input type="submit" class="btn"  name="submit" value="放入回收站" />
															</form>
														...
														<form action="<?php echo url('sadmin/index/change'); ?>" method="post">
															<table width="700" height="200" class="table table-condensed">
															<tr class="success">
																<td>姓名</td>
																<td>会员账号</td>
															...
															<tr class="danger">
																<input type="hidden" name="data[id][]" value="<?php echo $val->id; ?>"/>
																<td><input type="text" name="data[username][]" value="<?php echo $val->username; ?>"/></td>
																<td><input type="text" name="data[account][]" value="<?php echo $val->account; ?>"/></td>
																<td>
																	<?php if($val['lockuser'] == 0): ?>
																		<a href="__SITE__/sadmin/index/lock?id=<?php echo $val['id']; ?>"><font color="green">锁定用户</font></a>
																	<?php else: ?>
																		<a href="__SITE__/sadmin/index/unlock?id=<?php echo $val['id']; ?>"><font color="red">解锁用户</font></a>
																	<?php endif; ?>
																</td>
															</tr>
															<?php endforeach; ?>
														...
														<form action="<?php echo url('sadmin/index/softr'); ?>" method="post">
															...
															<tr class="success">
																<td><input type="checkbox" name="tt" value="<?php echo $val->id; ?>"></td>
...
<![endif]-->
		...
		<script src="__SITE__/static/assets/js/jquery.ui.touch-punch.min.js"></script>
		<script src="__SITE__/static/zassets/js/jquery.slimscroll.min.js"></script>
		<script src="__SITE__/static/zassets/js/jquery.easy-pie-chart.min.js"></script>
		<script src="__SITE__/static/zassets/js/jquery.sparkline.min.js"></script>
		<script src="__SITE__/static/zassets/js/flot/jquery.flot.min.js"></script>
		<script src="__SITE__/static/zassets/js/flot/jquery.flot.pie.min.js"></script>
		<script src="__SITE__/static/zassets/js/flot/jquery.flot.resize.min.js"></script>
