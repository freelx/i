<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:80:"/home/wwwroot/www.iseeyou.ac.cn/public/../application/badmin/view/mine/mine.html";i:1481708279;}*/ ?>
<!doctype html>
<html>
<head>
<meta charset="utf-8">
        ...
        <div class="ng-toolbar">
            ...
            <div class="ng-toolbar-con wrapper">
                <div class="ng-toolbar-left">
                    <a class="ng-bar-node ng-bar-node-backhome" id="ng-bar-node-backhome" style="display: block;" href="__SITE__/index/index/index">
                    ...
                    <div class="ms-side" style="margin-top: 20px;">
                        <article class="side-menu side-menu-off">
                            ...
                            <dt><img src="__SITE__/static/supp/img/左侧/我的购物车.png"  style="margin-right: 10px;margin-left: -20px;"/>店铺管理</dt>
                                <dd>
                                    <a href="__SITE__/badmin/index/index">店铺首页</a>
                                </dd>
                                <dd>
                            ...
                            <div class="server-tab" style="margin-top: 26px;">
                                ...
                                <table width="600px">
                                                        ...
                                                        <?php foreach($data as $val): ?>
                                                            <tr align="center">
                                                                <td><img src="<?php echo $val->pic; ?>" id="tu" /></td>
                                                                <td><?php echo $val->goods_name; ?></td>
                                                                <td><?php echo $val->num; ?></td>
                                                               
                                                                    <td>
                                                                    <?php if($val['state'] == 1): ?>
                                                                    <a href="__SITE__/badmin/mine/state?id=<?php echo $val['id']; ?>"><button type="button" class="btn btn-success">上架</button></a>
                                                                    <?php else: ?>   
                                                                    <a href="__SITE__/badmin/mine/unstate?id=<?php echo $val['id']; ?>"><button type="button" class="btn btn-danger">下架</button></a>
                                                                    <?php endif; ?>
                                                                    </td> 
                                                            </tr>
                                                        <?php endforeach; ?>
