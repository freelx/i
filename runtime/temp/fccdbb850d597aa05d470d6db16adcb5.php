<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:83:"/home/wwwroot/www.iseeyou.ac.cn/public/../application/cadmin/view/means/change.html";i:1481628594;}*/ ?>
<!DOCTYPE html>
<html>
	...
	<body>
		...
		<div class="am-g" >
			<div class="logo"> <img src="__SITE__/static/supp/img/logo.png" style="    float: left" />
				<p style="font-size: 16px;color: #3d3d3d;margin-left: 16px;font-weight: bold;margin-top: 20px;    float: left">修改个人信息</p>
			</div>
			<div style="width: 1200px;margin: 0 auto;font-size: 12px;margin-top: -38px;"> <span style="float: right;color: #333333;">欢迎您，尊敬的会员=><?php echo \think\Session::get('username'); ?><!-- <span style="margin-left: 20px;margin-right: 20px;">|</span>退出<span style="margin-left: 20px;margin-right: 20px;">|</span>我的买啦</span> -->
			</div>
		</div>
		</div>
				...
				<div data-am-widget="tabs" class="am-tabs am-tabs-d2">
					<ul class="am-tabs-nav1" style="margin-top: 20px;display:flex;list-style: none;text-align: center;">
						...
						<li style="max-width: 80px;margin-left: 10px;"><span class="am-badge1  am-round am-badge-warning-active" style="background-color: #F89406;font-size: 18px">赞</span>
							<br />
							<p class="bottitle active">修改个人信息</p>
						</li>
						
					</ul>
					<form action="<?php echo url('cadmin/Means/dochange'); ?>" method="post">
						<?php foreach($info as $val): ?>
							<div class="new">
							您的当前邮箱是<input type="text" name="email" value="<?php echo $val->email; ?>" style="width: 285px;height: 45px;margin-left: 20px;"><br /><br />
							您的当前地址是<input type="text" name="address" value="<?php echo $val->address; ?>" style="width: 285px;height: 45px;margin-left: 20px;"><br /><br />
